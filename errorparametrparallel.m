...
% Πραγματικές παράμετροι του συστήματος
m_true = 1.315;
b_true = 0.225;
k_true = 0.725;
...
title('Εξέλιξη Σφαλμάτων Εκτίμησης Παραμέτρων σε Συνάρτηση με το Πλάτος Θορύβου (Παράλληλη Δομή)');
legend('Σφάλμα Μάζας m', 'Σφάλμα Απόσβεσης b', 'Σφάλμα Σταθεράς Ελατηρίου k');
